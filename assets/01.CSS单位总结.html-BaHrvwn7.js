import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as e,o as p}from"./app-Cw3dfNnn.js";const t={};function l(i,n){return p(),a("div",null,n[0]||(n[0]=[e(`<h1 id="css-单位总结" tabindex="-1"><a class="header-anchor" href="#css-单位总结"><span><em>CSS</em> 单位总结</span></a></h1><h2 id="经典真题" tabindex="-1"><a class="header-anchor" href="#经典真题"><span>经典真题</span></a></h2><ul><li><em>px</em> 和 <em>em</em> 的区别</li></ul><h2 id="css-中的哪些单位" tabindex="-1"><a class="header-anchor" href="#css-中的哪些单位"><span><em>CSS</em> 中的哪些单位</span></a></h2><p>首先，在 <em>CSS</em> 中，单位分为两大类，<strong>绝对长度单位</strong>和<strong>相对长度单位</strong>。</p><h3 id="绝对长度单位" tabindex="-1"><a class="header-anchor" href="#绝对长度单位"><span>绝对长度单位</span></a></h3><p>我们先来说这个，绝对长度单位最好理解，和我们现实生活中是一样的。在我们现实生活中，常见的长度单位有米（<em>m</em>）、厘米（<em>cm</em>）、毫米（<em>mm</em>），每一种单位的长度都是固定，比如 <em>5cm</em>，你走到任何地方 <em>5cm</em> 的长度都是一致的</p><p>例如：</p><div class="language-html line-numbers-mode" data-ext="html" data-title="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>container<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code><span class="token selector">.container</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在上面的代码中，我们设置了盒子的宽高都是 <em>5cm</em>，这里用的就是绝对长度单位。</p><p>常见的绝对单位长度如下：</p><img src="https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2021-09-14-073818.png" alt="image-20210914153818508" style="zoom:50%;"><p>这些值中的大多数在用于打印时比用于屏幕输出时更有用。例如，我们通常不会在屏幕上使用 <em>cm</em>。</p><p>惟一一个经常使用的值，估计就是 <em>px</em>(像素)。</p><h3 id="相对长度单位" tabindex="-1"><a class="header-anchor" href="#相对长度单位"><span>相对长度单位</span></a></h3><p>相对长度单位相对于其他一些东西，比如父元素的字体大小，或者视图端口的大小。使用相对单位的好处是，经过一些仔细的规划，我们可以使文本或其他元素的大小与页面上的其他内容相对应。</p><p>下表列出了 <em>web</em> 开发中一些最有用的单位。</p><p><img src="https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2021-09-14-074021.png" alt="image-20210914154021389"></p><p>上面的单位中，常用的有 <em>em、rem、vw、vh</em>，其中 <em>vw</em> 和 <em>vh</em> 代表的是视口的宽度和高度，例如：</p><div class="language-html line-numbers-mode" data-ext="html" data-title="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>container<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code><span class="token selector">*</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code><span class="token selector">*</span> <span class="token punctuation">{</span>
  <span class="token property">margin</span><span class="token punctuation">:</span> 0<span class="token punctuation">;</span>
  <span class="token property">padding</span><span class="token punctuation">:</span> 0<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
<span class="token selector">div</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">/* 400px */</span>
...
<span class="token selector">p</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">width</span><span class="token punctuation">:</span> 10em<span class="token punctuation">;</span>
  <span class="token comment">/* 200px */</span>
  <span class="token property">height</span><span class="token punctuation">:</span> 10em<span class="token punctuation">;</span>
...
<span class="token selector">span</span> <span class="token punctuation">{</span>
  ...
  <span class="token property">display</span><span class="token punctuation">:</span> block<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>所以当用 <em>rem</em> 做响应式时，直接在媒体中改变 <em>html</em> 的 <em>font-size</em>，此时用 <em>rem</em> 作为单位的元素的大小都会相应改变，很方便。</p><p>看到这里我想大家都能够更深刻的体会了 <em>em</em> 和 <em>rem</em> 的区别了，其实就是参照物不同。</p><h2 id="真题解答" tabindex="-1"><a class="header-anchor" href="#真题解答"><span>真题解答</span></a></h2><ul><li><em>px</em> 和 <em>em</em> 的区别</li></ul><blockquote><p>参考答案：</p><p><em>px</em> 即 <em>pixel</em> 像素，是相对于屏幕分辨率而言的，是一个绝对单位，但是具有一定的相对性。因为在同一设备上每个设备像素所代表的物理长度是固定不变的（绝对性），但在不同设备间每个设备像素所代表的物理长度是可以变化的（相对性）。</p><p><em>em</em> 是相对长度单位，具体的大小要相对于父元素来计算，例如父元素的字体大小为 <em>40px</em>，那么子元素 <em>1em</em> 就代表字体大小和父元素一样为 <em>40px</em>，<em>0.5em</em> 就代表字体大小为父元素的一半即 <em>20px</em>。</p></blockquote><p>-<em>EOF</em>-</p>`,44)]))}const u=s(t,[["render",l],["__file","01.CSS单位总结.html.vue"]]),m=JSON.parse('{"path":"/interview/css/01.CSS%E5%8D%95%E4%BD%8D%E6%80%BB%E7%BB%93.html","title":"CSS单位总结","lang":"zh-CN","frontmatter":{"title":"CSS单位总结","description":"CSS中各种单位的使用和区别","permalink":"/interview/css/01.CSS单位总结.html"},"headers":[{"level":2,"title":"经典真题","slug":"经典真题","link":"#经典真题","children":[]},{"level":2,"title":"CSS 中的哪些单位","slug":"css-中的哪些单位","link":"#css-中的哪些单位","children":[{"level":3,"title":"绝对长度单位","slug":"绝对长度单位","link":"#绝对长度单位","children":[]},{"level":3,"title":"相对长度单位","slug":"相对长度单位","link":"#相对长度单位","children":[]}]},{"level":2,"title":"真题解答","slug":"真题解答","link":"#真题解答","children":[]}],"git":{"createdTime":1752318628000,"updatedTime":1753164176000,"contributors":[{"name":"DJQZSX","email":"1745786806@qq.com","commits":1},{"name":"三月崽崽","email":"1745786806@qq.com","commits":1}]},"readingTime":{"minutes":3.7,"words":1110},"filePathRelative":"interview/css/01.CSS单位总结.md","localizedDate":"2025年7月12日"}');export{u as comp,m as data};
